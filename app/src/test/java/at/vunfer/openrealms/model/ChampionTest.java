...
public class ChampionTest {
    ...
    public void testConstructorValid() {
        ...
        List<Effect> effects = List.of(new DamageEffect(1), new HealingEffect(1), new CoinEffect(1));
    ...
    public void testConstructorInvalid() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Champion("Test Champion", -3, effects));
        assertThrows(IllegalArgumentException.class, () -> new Champion("Test Champion", 3, null));
        assertThrows(IllegalArgumentException.class, () -> new Champion("Test Champion", 3, List.of()));
    }
    ...
    public void testApplyEffects() {
        ...
        Champion champion = new Champion("Test Champion", 3, List.of(new DamageEffect(1), new HealingEffect(1)));
    ...
    public void testToString() {
        Champion champion = new Champion("Test Champion", 3, List.of(new DamageEffect(1), new HealingEffect(1), new CoinEffect(1)));
